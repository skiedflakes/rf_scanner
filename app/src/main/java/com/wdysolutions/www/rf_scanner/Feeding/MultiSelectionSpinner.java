...
public class MultiSelectionSpinner extends AppCompatSpinner implements OnMultiChoiceClickListener {
    ...
    public interface OnMultipleItemsSelectedListener{
        void selectedIndices(List<Integer> indixes);
    ...
    public MultiSelectionSpinner(Context context) {
        ...
        simple_adapter = new ArrayAdapter<>(context, R.layout.custom_spinner);
    ...
    public boolean performClick() {
        ...
        builder.setNeutralButton("Select All", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                System.arraycopy(mSelectionAtStart, 0, mSelection, 0, mSelectionAtStart.length);
                try{
                    listener.selectedIndices(getSelectedIndices_ALL());
                } catch (Exception e){}
            }
        });
        builder.show();
    ...
    public List<Integer> getSelectedIndices_ALL() {
        List<Integer> selection = new LinkedList<>();
        for (int i = 0; i < _items.length; ++i) {
            selection.add(i);
        }
