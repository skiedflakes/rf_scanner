...
package com.wdysolutions.www.rf_scanner.Bluetooth;
...
//				));
				...
				if( !moreAvailable) {
					sendMessageNotification(String.valueOf(transponder.getWordsWritten()));
				}
			}
		});
	}
